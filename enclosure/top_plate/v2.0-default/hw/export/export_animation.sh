...
OUTPUT_DIR="_rotate"
INPUT_FILE="../top_plate.kicad_pcb"
ZOOM=0.8
WIDTH=2560
HEIGHT=1440
...
ffmpeg -y -framerate $FRAMERATE -i "$OUTPUT_DIR/frame%d.png" -vf "crop=iw*0.5:ih*0.6,scale=860:-1:flags=lanczos,fps=30" -loop 0 -q:v 40 -lossless 0 -an -map_metadata -1 rotate.webp
